describe("In Jungle", function () {
    ...
    function expectException(turnIndexBeforeMove, boardBeforeMove, deltaFrom, deltaTo) {
        var stateBeforeMove = boardBeforeMove ? { board: boardBeforeMove, boardBefore: null, fromDelta: null, toDelta: null } : null;
    ...
    it("3. move Rdog from[1,1] to [2,1] (move downward)", function () {
        expectMove(R_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['Belephant', 'G', 'Bwolf', 'G', 'Bcheetah', 'G', 'Bmouse'],
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['Btiger', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 1, col: 1 }, { row: 2, col: 1 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'G', 'G', 'RT', 'G', 'Rcat', 'G'],
    ...
    it("4. move Bmouse from[5,6] to [5,5] (move left into the water)", function () {
        expectMove(B_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['Belephant', 'G', 'Bwolf', 'G', 'Bcheetah', 'G', 'G'],
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['Btiger', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 5, col: 6 }, { row: 5, col: 5 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['Rmouse', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("5. try to move Bcheetah from[5,6] to [5,5] left into the water, invalid move", function () {
        expectException(B_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['Rmouse', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("6. move Btiger from[6,1] to [2,1] (jump across the water and land on the grass)", function () {
        expectMove(B_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 6, col: 1 }, { row: 2, col: 1 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
    ...
    it("7. move Blion from[6,5] to [2,5] (jump across the water and land on the grass)", function () {
        expectMove(B_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'G']], { row: 6, col: 5 }, { row: 2, col: 5 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
    ...
    it("8. move Blion from[6,5] to [6,6] to eat the Rmouse", function () {
        expectMove(B_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'G']], { row: 6, col: 5 }, { row: 6, col: 6 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("9. move Blion from[6,5] to [6,6] to eat the Rlion", function () {
        expectMove(B_TURN, [['G', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'G']], { row: 6, col: 5 }, { row: 6, col: 6 }, [['G', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("10. try to move Rmouse from[6,6] to [6,5] to eat Blion, invalid move", function () {
        expectException(R_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("11. move Rmouse from [6,6] to [6,5] to eat the Belephant", function () {
        expectMove(R_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'G']], { row: 6, col: 6 }, { row: 6, col: 5 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("13. move Rmouse from [5,5] to [5,4] to eat the Bmouse", function () {
        expectMove(R_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'G']], { row: 5, col: 5 }, { row: 5, col: 4 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("18. move Btiger from [6,1] to [2,1] to eat the Rdog", function () {
        expectMove(B_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['G', 'Btiger', 'Bwolf', 'G', 'Bcheetah', 'Belephant', 'G'],
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['G', 'G', 'BT', 'BH', 'BT', 'G', 'G']], { row: 6, col: 1 }, { row: 2, col: 1 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'G', 'G', 'RT', 'G', 'Rcat', 'G'],
    ...
    it("24. move Relephant from [7,4] to [7,3] to eat Bdog in BT", function () {
        expectMove(R_TURN, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ...
            ['Btiger', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 7, col: 4 }, { row: 7, col: 3 }, [['Rlion', 'G', 'RT', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Rmouse'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("25. move Rdog from [0,1] to [0,2] to eat Belephant in RT", function () {
        expectMove(R_TURN, [['Rlion', 'Rdog', 'Belephant', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'G', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Rmouse'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ...
            ['G', 'Bcat', 'G', 'Bdog', 'Relephant', 'G', 'G'],
            ['Btiger', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 0, col: 1 }, { row: 0, col: 2 }, [['Rlion', 'G', 'Rdog', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'G', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['G', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Rmouse'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("26. move Rlion from [0,1] to [0,2] to eat Bdog in RT", function () {
        expectMove(R_TURN, [['G', 'Rlion', 'Bdog', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['Rmouse', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ...
            ['Belephant', 'G', 'Bwolf', 'G', 'Bcheetah', 'G', 'Bmouse'],
            ['G', 'Bcat', 'G', 'BT', 'G', 'G', 'G'],
            ['Btiger', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 0, col: 1 }, { row: 0, col: 2 }, [['G', 'G', 'Rlion', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['Rmouse', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("27. try to move Rlion from [0,2] to [0,3] to enter RH, invalid move", function () {
        expectException(R_TURN, [['G', 'G', 'Rlion', 'RH', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['Rmouse', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
    ...
    it("33. move Belephant from[5,3] to [4,3], the only red animal- Rdog left)", function () {
        expectMove(B_TURN, [['G', 'G', 'RT', 'RH', 'RT', 'G', 'G'],
            ...
            ['G', 'Bcat', 'G', 'BT', 'G', 'Bdog', 'G'],
            ['Btiger', 'G', 'BT', 'BH', 'BT', 'G', 'Blion']], { row: 5, col: 3 }, { row: 4, col: 3 }, [['G', 'G', 'RT', 'RH', 'RT', 'G', 'G'],
            ['G', 'G', 'G', 'RT', 'G', 'G', 'G'],
            ['G', 'G', 'G', 'Bwolf', 'G', 'G', 'G'],
            ['G', 'W', 'W', 'Rdog', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'Belephant', 'W', 'W', 'G'],
    ...
    it("35. when game is over, try to move Rtiger from [0,6] to [0,5], invalid move", function () {
        expectException(NO_ONE_TURN, [['G', 'G', 'Rlion', 'Bcheetah', 'RT', 'G', 'Rtiger'],
            ['G', 'Rdog', 'G', 'RT', 'G', 'Rcat', 'G'],
            ['Rmouse', 'G', 'Rcheetah', 'G', 'Rwolf', 'G', 'Relephant'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
            ['G', 'W', 'W', 'G', 'W', 'W', 'G'],
